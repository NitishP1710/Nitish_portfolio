...
const Sidebar = () => {
  ...
  return (
    <>
      <aside
        className={`bg-eerie-black-2 border border-jet rounded-[20px] p-4 shadow-[var(--shadow-1)] z-[1] mb-4 transition-all duration-500 overflow-hidden
      ...
      >
        ...
        <div className="relative flex items-center gap-4 md:gap-6 lg:flex-col">
          ...
          >
            ...
            <IoChevronDown
              className={`md:hidden text-orange-yellow transition-transform duration-300 ${
